        ...
        <div>
            <div className="bg-white p-4 md:p-6 rounded-xl w-full">
                <div className="flex justify-between">
                    <div>
                        <h5 className="pb-2 font-bold text-3xl text-gray-900 dark:text-white leading-none">
                            Project Stastics
                        </h5>
                    </div>
                    <div className="flex items-center px-2.5 py-0.5 font-semibold text-base text-center text-green-500 dark:text-green-500">
                        23%
                        <svg
